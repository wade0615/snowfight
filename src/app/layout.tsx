...
export const metadata: Metadata = {
  ...
  description:
    "免費線上打雪仗遊戲！體驗刺激的雪球大戰，支援電腦和手機。Free online snowball fight game! Battle enemies in an epic snowball war. Play on desktop and mobile.",
  keywords: [
    "snowball fight",
    "snowball game",
    "snowfight",
  ...
  authors: [{ name: "Costhrough" }],
  creator: "Costhrough",
  publisher: "Costhrough",
  alternates: {
    canonical: "/",
  },
  ...
  openGraph: {
    ...
    description:
      "免費線上雪球大戰！與敵人對戰，體驗刺激的打雪仗遊戲。Free online snowball fight! Battle enemies in an epic snowball war.",
    url: "/",
    type: "website",
    locale: "zh_TW",
...
const jsonLd = {
  ...
  description:
    "免費線上打雪仗遊戲！體驗刺激的雪球大戰。Free online snowball fight game! Battle enemies in an epic snowball war.",
  url: siteUrl,
  genre: ["Action", "Casual"],
