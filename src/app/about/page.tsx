...
export const metadata: Metadata = {
  ...
  description:
    "關於打雪仗遊戲：一款免費的像素風格雪球大戰網頁遊戲。About Snowball Fight: A free pixel-art snowball battle web game.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
...
const jsonLd = {
  ...
  description:
    "About Snowball Fight - a free pixel-art snowball battle web game.",
  isPartOf: {
    "@type": "WebSite",
    name: "Snowball Fight",
    url: siteUrl,
